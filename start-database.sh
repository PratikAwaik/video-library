...
DB_CONTAINER_NAME="vidext-2-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=vidext-2 -d -p 5432:5432 docker.io/postgres
